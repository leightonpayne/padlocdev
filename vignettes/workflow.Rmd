...
path_db <- "~/tools/padloc_update_230119/"
...
group_overlap
# models_filtered <- filter_models(models_expanded, sys_groups, c("DRT", "new"))
# intersect <- pull_intersect(group_overlap, "DRT", "new")
# which_use <- which_uses(intersect, models_filtered) %>% unlist() %>% unique()
# sys_groups[sys_groups$yaml.name %in% which_use,]
